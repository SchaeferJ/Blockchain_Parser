...
mkdir headers
echo 'txid:ID(Transaction)' > ./headers/transactions-header.csv
...
echo ':START_ID(Transaction),value,output_nr:int,:END_ID(Address),:TYPE' > ./headers/recieves-rel-header.csv
